...
public final class ChunkConfigManager {
	...
	private static final String CHUNK_CONFIG_FOLDER_NAME = "madoku-craft-core/madoku-chunk";
	...
	private static void loadConfig() {
		...
		try {
			Path rootDirectory = JSONAPIManager.getOrCreateGlobalSystemDirectory(CHUNK_CONFIG_FOLDER_NAME);
